...
void	move_left(/*t_map *_map,*/ t_game *game)
{
	t_map	*map;
...
void	move_right(/*t_map *_map,*/ t_game *game)
{
	t_map	*map;
...
void	move_down(/*t_map *_map,*/ t_game *game)
{
	t_map	*map;
...
void	move_up(/*t_map *_map,*/ t_game *game)
{
	t_map	*map;
